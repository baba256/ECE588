...
#cudaRenderer: sceneLoader.o benchmark.o refRenderer.o noise.o ppm.o cudaRenderer.o main.o
cuda_renderer:  cuda_renderer.o main.o
...
clean:
	#rm -f cudaRenderer cudaRenderer.o display.o benchmark.o refRenderer.o noise.o ppm.o main.o sceneLoader.o
	
	rm -f cuda_renderer cuda_renderer.o   r main.o 
	rm -rf ../../bin/$(OS_ARCH)/$(OSLOWER)/$(TARGET)$(if $(abi),/$(abi))/cudaRenderer
